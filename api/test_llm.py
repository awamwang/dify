...
class GoogleLargeLanguageModel(LargeLanguageModel):
    ...
    def _to_client_options(self, credentials: dict) -> dict:
        """
        Transform credentials to options used by google.generativeai client
        ...
        if 'google_api_base' in credentials and credentials['google_api_base']:
            credentials['google_api_base'] = credentials['google_api_base'].rstrip('/')
            options['api_endpoint'] = credentials['google_api_base']
    ...
    def _generate(self, model: str, credentials: dict,
        ...
        client_options = self._to_client_options(credentials)
        print(client_options, config_kwargs)
        new_client_manager.configure(client_options=client_options)
...
m = GoogleLargeLanguageModel()
m.validate_credentials("gemini-pro", {"google_api_base": "palm.tong-you.cn", "google_api_key": "AIzaSyAQkFGIt_hnGo4paGIiAnj6w806MQZJK0g"})
